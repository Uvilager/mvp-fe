...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,description,body,startDate,endDate,maxUsers,minUsers,status,projectUrl,upvotes,downvotes,budget,pointsEarned,organizer,const DeepCollectionEquality().hash(_tags),const DeepCollectionEquality().hash(_sponsors),createdAt,updatedAt,district,hasUserVoted,isUserVolunteer,volunteersCount,leadersCount]);
